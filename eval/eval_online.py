...
from models.actor_critic_aug import ActorCriticAugLN as ActorCriticAug
...
def run_eval(args):
    ...
    model = ActorCriticAug(OBS_DIM, ACTION_DIM, layer_width, EMBED_HIDDEN_DIM, dropout=args.dropout).to(device)
